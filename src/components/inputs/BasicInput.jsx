...
export const BasicInput = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex transition-all flex-row justify-between items-center p-3 gap-2 rounded-lg border-2 border-solid border-[#D5D4DC]   ${
      ...
      >
        <input
          autoComplete="off"
          type={type}
          className={`w-full overflow-ellipsis bg-transparent text-black placeholder:font-normal font-medium text-base border-none active:border-none outline-none focus:outline-none focus:border-none
            ${error && "text-error"}`}
